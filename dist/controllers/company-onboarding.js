    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const onboardingData = {
                ...
                logoUrl: (_a = payload.logoUrl) !== null && _a !== void 0 ? _a : null,
                companyType,
                phoneNumbers,
                ...
                incorporationDate: (_b = parseDate(payload.incorporationDate)) !== null && _b !== void 0 ? _b : null,
...
function approveCompanyOnboarding(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            (0, notifications_1.notifyOnboardingApproved)(updated.userId, true).catch((err) => console.error("[notifications] onboarding-approved (company) failed:", err));
            return res.status(200).json({ ok: true, data: updated });
        }
        catch (e) {
