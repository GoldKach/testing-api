...
exports.regenerateReportForPortfolio = regenerateReportForPortfolio;
...
function regenerateReportForPortfolio(userPortfolioId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield generateAndSaveReport(userPortfolioId, today);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            for (const up of userPortfolios) {
                ...
                const reportId = yield generateAndSaveReport(up.id, date);
                results.push({
                    userPortfolioId: up.id,
