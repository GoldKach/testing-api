...
function parseUserAgent(ua) {
    ...
    if (edgeM)
        browser = `Edge ${edgeM[1].split(".")[0]}`;
    else if (operaM)
        browser = `Opera ${operaM[1].split(".")[0]}`;
    else if (chromM)
        browser = `Chrome ${chromM[1].split(".")[0]}`;
    else if (ffM)
        browser = `Firefox ${ffM[1].split(".")[0]}`;
    else if (safM)
        browser = `Safari ${safM[1].split(".")[0]}`;
    else if (ieM)
        browser = `IE ${ieM[1].split(".")[0]}`;
    let os = "Unknown";
