// emails/OnboardingSubmittedEmail.tsx
import * as React from "react";
import {
  Html, Body, Container, Text, Hr, Link, Img, Section, Heading, Button,
} from "@react-email/components";

export default function OnboardingSubmittedEmail({
  name = "there",
  isCompany = false,
}: {
  name?: string;
      ...
      <Body style={{ fontFamily: "system-ui, -apple-system, Segoe UI, Roboto, sans-serif", backgroundColor: "#f9fafb" }}>
        <Container style={{ maxWidth: 560, margin: "32px auto", padding: 0, borderRadius: 16, overflow: "hidden", border: "1px solid #e5e7eb" }}>
          ...
          <Section style={{ backgroundColor: "#ffffff", padding: "32px 32px 24px" }}>
            ...
            <Text style={{ color: "#374151", fontSize: 15, lineHeight: "24px", margin: "0 0 16px" }}>
              Thank you for completing your {isCompany ? "company" : ""} onboarding application with{" "}
              <strong>GoldKach Investment</strong>. We have successfully received all your information and
              documents.
            </Text>
            ...
            <Section style={{
              ...
              <Text style={{ color: "#1E3A8A", fontSize: 14, fontWeight: 600, margin: "0 0 6px" }}>
                ⏱ Processing Time
              </Text>
              <Text style={{ color: "#1E3A8A", fontSize: 14, margin: 0, lineHeight: "22px" }}>
                Please allow up to <strong>48 hours</strong> for our compliance team to review and verify
                your application. We may reach out if additional information is required.
              </Text>
            </Section>
            ...
            <Section style={{
              ...
              <Text style={{ color: "#4B5563", fontSize: 14, margin: 0, lineHeight: "22px" }}>
                Once your account is approved, you will receive a confirmation email. You can then log in
                and make your first deposit to be allocated to one or more investment portfolios.
              </Text>
            </Section>
