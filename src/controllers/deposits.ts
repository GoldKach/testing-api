...
/**
 * POST /deposits
 * Body: { walletId, userId, amount, transactionId?, transactionStatus?, mobileNo?, referenceNo?, AccountNo?, ApprovedBy?, method?, description? }
 * If transactionStatus === COMPLETED, the wallet is credited atomically.
 */
